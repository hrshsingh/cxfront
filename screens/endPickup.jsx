...
const EndPickupScreen = ({navigation}) => {
  return (
    <View style={styles.container}>
     ...
     source={require('../assets/map.png')} // <- your uploaded image
      ...
      <View style={styles.topHeader}>
        ...
        <Text style={styles.headerText}>End Pickup</Text>
      ...
      <View style={styles.bottomCard}>
        ...
        <TouchableOpacity style={styles.startButton}>
          <Text style={styles.startButtonText}>End Pickup</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default EndPickupScreen;
